...
export default function App() {
  ...
  const reset=()=>{setAnimIn(false);setTimeout(()=>{setSupplier(null);setT2eExisting(null);setScanners(1);setWeighPays(0);setSmeDays(1);setSiteName("");setUnitNumber("");setContactName("");setAddress("");setGoLive("");setStep("supplier");setAnimIn(true);},180);};

  const result=step==="summary"?calcQuote({supplier,scanners,weighPays,smeDays,t2eExisting}):null;
  const siteInfo={siteName,unitNumber,contactName,address,goLive};
        ...
        <div className={animIn?"page-in":"page-out"}>
          ...
          {step==="siteinfo"&&(<>
            ...
            <div className="card">
              ...
              <div className="fg">
                <div className="fgrp"><label className="flbl">Site Name *</label><input className="finp" style={{"--sc":sc}} value={siteName} onChange={e=>setSiteName(e.target.value)} placeholder="e.g. Bank of Canada"/></div>
            ...
            <div className="btn-row"><button className="btn-g" onClick={goBack}>← Back</button><button className="btn-p" disabled={!siteName||!contactName||!goLive} style={{background:(siteName&&contactName&&goLive)?sc:"#e5e7eb",color:(siteName&&contactName&&goLive)?"#fff":"#9ca3af"}} onClick={goNext}>View Quote →</button></div>
          </>)}
